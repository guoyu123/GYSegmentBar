...
#import "UIView+GYSegmentBar.h"

@interface GYSementBarVC ()<GYSegmentBarDelegate, UIScrollViewDelegate>

@property (nonatomic, weak) UIScrollView *contentView;

@end

@implementation GYSementBarVC
...
- (void)viewWillLayoutSubviews {
    ...
    if (self.segmentBar.superview == self.view) {
       // self.segmentBar.frame = CGRectMake(0, 64, self.view.width, 35);
...
#pragma mark - 懒加载
- (GYSegmentBar *)segmentBar {
    
    if (!_segmentBar) {
        
        GYSegmentBar *segmentBar = [GYSegmentBar segmentBarWithFrame:CGRectZero];
