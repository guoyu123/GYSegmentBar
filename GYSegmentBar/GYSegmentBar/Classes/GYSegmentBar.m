...
/** 选项卡配置 */
@property (nonatomic, strong) GYSegmentBarConfig *config;

@end

@implementation GYSegmentBar

#pragma mark - 接口
+ (instancetype)segmentBarWithFrame: (CGRect)frame {
    
    GYSegmentBar *segmentBar = [[GYSegmentBar alloc] initWithFrame:frame];
    return segmentBar;
}
...
- (GYSegmentBarConfig *)config {
    if (!_config) {
        _config = [GYSegmentBarConfig defaultConfig];
    }
    return _config;
}
